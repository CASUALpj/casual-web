      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 text-lg md:text-xl leading-relaxed text-foreground/90">
            ...
            <p className="text-center">
              Unlike some GameFi that push tokens before fun, we focus on real player engagement first— friendly games, low learning curve and absolutely no blockchain friction during gameplay, ensuring the fun sticks.
            </p>
          </div>
        </div>
      </main>
